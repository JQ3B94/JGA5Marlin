 ...
 * And the config file by Telli Mantelli, Kris Waclawski, Samuel Pinches & Michael Gilardi, 21 Jan 2018
 * 
...
#define STRING_CONFIG_H_AUTHOR "(Joseph W, and Millie the cat. 3rd july 2023)" // Who made the changes.
...
// Generally expected filament diameter in milimeters (1.75, 2.85, 3.0, ...). Used for Volumetric, Filament Width Sensor, etc.
